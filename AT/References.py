...
def show_references():
    ...
    """
    Aitken, P. P. (1974). Judgments of pleasingness and interestingness as functions of visual complexity. Journal of Experimental Psychology, 103(2), 240-244. https://doi.org/10.1037/h0036787 

    Aks, D. J., & Sprott, J. C. (1996). Quantifying aesthetic preference for chaotic patterns. Empirical Studies of the Arts, 14(1), 1-16. https://doi.org/10.2190/6V31-7M9R-T9L5-CDG9 

    Alvarez-Ramirez, J., Ibarra-Valdez, C., Rodriguez, E., & Dagdug, L. (2008). 1/f-noise structures in Pollock's drip paintings. Physica A, 387, 281-295. 
    
    Amirshahi, S. A., Hayn-Leichsenring, G. U., Denzler, J., & Redies, C. (2015). JenAesthetics subjective dataset: Analyzing paintings by subjective scores. Lecture Notes in Computer Science, 8925, 3-19. https://doi.org/10.1007/978-3-319-16178-5_1 
    ...
    Bekhtereva, V., & Muller, M. M. (2017). Bringing color to emotion: The influence of color on attentional bias to briefly presented emotional images. Cognitive, Affective, & Behavioral Neuroscience, 17(5), 1028-1047. https://doi.org/10.3758/s13415-017-0530-z 
    ...
    Bies, A. J., Blanc-Goldhammer, D. R., Boydston, C. R., Taylor, R. P., & Sereno, M. E. (2016). Aesthetic responses to exact fractals driven by physical complexity. Frontiers in Human Neuroscience, 10, 210. https://doi.org/10.3389/fnhum.2016.00210 
    
    Bies, A. J., Boydston, C. R., Taylor, R. P., & Sereno, M. E. (2016). Relationship between fractal dimension and spectral scaling decay rate in computer-generated fractals. Symmetry-Basel, 8(7). https://doi.org/10.3390/sym8070066 
    
    Bode, C., Helmy, M., & Bertamini, M. (2017). A cross-cultural comparison for preference for symmetry: comparing British and Egyptians non-experts. Psihologija, 50, 383-402. https://doi.org/10.2298/PSI1703383B 
    ...
    Bowers, J. S., Malhotra, G., Dujmovic, M., Montero, M. L., Tsvetkov, C., Biscione, V., Puebla, G., Adolfi, F., Hummel, J. E., Heaton, R. F., Evans, B. D., Mitchell, J., & Blything, R. (2022). Deep problems with neural network models of human vision. Behavioral and Brain Sciences, 46. https://doi.org/10.1017/S0140525X22002813 
    ...
    Brachmann, A., & Redies, C. (2017a). Computational and experimental approaches to visual aesthetics. Frontiers in Computational Neuroscience, 11, 102. https://doi.org/10.3389/fncom.2017.00102 
    
    Brachmann, A., & Redies, C. (2017b). Defining self-similarity of images using features learned by convolutional neural networks Electronic Imaging, Human Vision and Electronic Imaging 2017, Burlingame, CA. 
    
    Braun, J., Amirshahi, S. A., Denzler, J., & Redies, C. (2013). Statistical image properties of print advertisements, visual artworks and images of architecture. Frontiers in Psychology, 4, 808. https://doi.org/10.3389/fpsyg.2013.00808 
    ...
    Chamberlain, R. (2022). The interplay of objective and subjective factors in empirical aesthetics. In B. Ionescu, W. A. Bainbridge, & N. Murray (Eds.), Human Perception of Visual Information (pp. 115-132). Cham: Springer. 
    ...
    Damiano, C., Wilder, J., Zhou, E. Y., Walther, D. B., & Wagemans, J. (2023). The role of local and global symmetry in pleasure, interest, and complexity judgments of natural scenes. Psychology of Aesthetics, Creativity, and the Arts, 17(3), 322-337. https://doi.org/10.1037/aca0000398 
    ...
    Fairbanks, M. S., & Taylor, R. P. (2010). Measuring the scaling properties of temporal and spatial patterns: From the human eye to the foraging albatross. In Nonlinear dynamical systems analysis for the behavioral sciences using real data. Boca Raton: CRC Press. 
    
    Farzanfar, D., & Walther, D. B. (2023). Changing what you like: Modifying contour properties shifts aesthetic valuations of scenes. Psychological Science, 34(10), 1101-1120. https://doi.org/10.1177/09567976231190546 
    
    Fernandez, D., & Wilkins, A. J. (2008). Uncomfortable images in art and nature. Perception, 37(7), 1098-1113. https://doi.org/10.1068/p5814 
    
    Field, D. J. (1987). Relations between the statistics of natural images and the response properties of cortical cells. Journal of the Optical Society of America A. Image Science and Vision, 4(12), 2379-2394. 
    ...
    Forsythe, A., Nadal, M., Sheehy, N., Cela-Conde, C. J., & Sawey, M. (2011). Predicting beauty: fractal dimension and visual complexity in art. British Journal of Psychology, 102(1), 49-70. https://doi.org/10.1348/000712610X498958 
    ...
    Gómez-Puerto, G., Munar, E., & Nadal, M. (2016). Preference for curvature: A historical and conceptual framework. Frontiers in Human Neuroscience, 9, 712. https://doi.org/10.3389/fnhum.2015.00712 
    ...
    Grebenkina, M., Brachmann, A., Bertamini, M., Kaduhm, A., & Redies, C. (2018). Edge orientation entropy predicts preference for diverse types of man-made images. Frontiers in Neuroscience, 12, 678. https://doi.org/10.3389/fnins.2018.00678 
    
    Güclütürk, Y., Jacobs, R. H., & van Lier, R. (2016). Liking versus complexity: Decomposing the inverted U-curve. Frontiers in Human Neuroscience, 10, 112. https://doi.org/10.3389/fnhum.2016.00112 
    
    Hekkert, P. (2006). Design aesthetics: principles of pleasure in design. Psychology Science, 2006, 157-172. 
    ...
    Ibarra, F. F., Kardan, O., Hunter, M. R., Kotabe, H. P., Meyer, F. A. C., & Berman, M. G. (2017). Image feature types and their predictions of aesthetic preference and naturalness. Frontiers in Psychology, 8, 632. https://doi.org/10.3389/fpsyg.2017.00632 
    ...
    Joye, Y. (2007). Architectural lessons from environmental psychology: the case of biophilic architecture. Review of General Psychiatry, 11, 305-328. 
    ...
    Kriegeskorte, N. (2015). Deep neural networks: A new framework for modeling biological vision and brain information processing. Annual Review in Vision Science, 1, 417-446. https://doi.org/10.1146/annurev-vision-082114-035447 
    
    Krizhevsky, A., Sutskever, I., & Hinton, G. E. (2012). Imagenet classification with deep convolutional neural networks. Advances in Neural Information Processing Systems, 25, 1097-1105. 
    
    Latto, R. (1995). The brain of the beholder. In R. L. Gregory, J. Harris, P. Heard, & D. Rose (Eds.), The artful eye (pp. 66-94). New York, NY: Oxford University Press. 
    
    Lecun, B., & Bengio, Y. (1995). Convolutional networks for images, speech, and time series. Handbook of Brain Theory and Neural Networks, 3361, 1995. 
    ...
    Leder, H., Tinio, P. P., Brieber, D., Kröner, T., Jacobsen, T., & Rosenberg, R. (2019). Symmetry is not a universal law of beauty. Empirical Studies of the Arts, 37(1), 104-114. https://doi.org/10.1177/02762374187779 
    ...
    Lindsay, G. W. (2020). Convolutional Neural Networks as a model of the visual system: Past, present, and future. Journal of Cognitive Neuroscience, 33, 2017-2031. https://doi.org/10.1162/jocn_a_01544 
    
    Liu, J., Slota, G., Zheng, G., Wu, Z., Park, M., Lee, S., Rauschert, I., & Liu, Y. (2013). Symmetry Detection from Real World Images Competition 2013: Summary and Results. IEEE Computer Society Conference on Computer Vision and Pattern Recognition Workshops (CVPRW) 200-205. 
    
    Locher, P. J., Stappers, P. J., & Overbeeke, K. (1999). An empirical evaluation of the visual rightness theory of pictorial composition. Acta Psychologica, 103, 261-280. 
    
    Luo, Y., & Tang, X. (2008). Photo and video quality evaluation: Focusing on the subject. Computer Vision – ECCV 2008, Lecture Notes in Computer Science, 5304, 386-399. 
    
    Lyssenko, N., Redies, C., & Hayn-Leichsenring, G. U. (2016). Evaluating abstract art: Relation between term usage, subjective ratings, image properties and personality traits. Frontiers in Psychology, 7, 973. https://doi.org/10.3389/fpsyg.2016.00973 
    
    Machado, P., Romero, J., Nadal, M., Santos, A., Correia, J., & Carballal, A. (2015). Computerized measures of visual complexity. Acta Psychologica (Amsterdam), 160, 43-57. https://doi.org/10.1016/j.actpsy.2015.06.005 
    
    Madan, C. R., Bayer, J., Gamer, M., Lonsdorf, T. B., & Sommer, T. (2018). Visual complexity and affect: Ratings reflect more than meets the eye. Frontiers in Psychology, 8. https://doi.org/10.3389/fpsyg.2017.02368 
    ...
    Marin, M. M., & Leder, H. (2013). Examining complexity across domains: Relating subjective and objective measures of affective environmental scenes, paintings and music. PLoS One, 8(8). https://doi.org/10.1371/journal.pone.0072412 
    ...
    Mayer, S., & Landwehr, J. R. (2018). Quantifying visual aesthetics based on processing fluency theory: Four algorithmic measures for antecedents of aesthetic preferences. Psychology of Aesthetics, Creativity, and the Arts, 12, 399-431. https://doi.org/10.1037/aca0000187 
    
    McCormack, J., & Gambardella, C. C. (2022). Complexity and aesthetics in generative and evolutionary art. Genetic Programming and Evolvable Machines, 23(4), 535-556. https://doi.org/10.1007/s10710-022-09429-9 
    ...
    Melmer, T., Amirshahi, S. A., Koch, M., Denzler, J., & Redies, C. (2013). From regular text to artistic writing and artworks: Fourier statistics of images with low and high aesthetic appeal. Frontiers in Human Neuroscience, 7, 106. https://doi.org/10.3389/fnhum.2013.00106 
    
    Mureika, J. R., & Taylor, R. P. (2013). The abstract expressionists and les automatistes: A shared multi-fractal depth? Signal Processing, 93, 573–578. 
    ...
    Nascimento, S. M., Linhares, J. M., Montagner, C., Joao, C. A., Amano, K., Alfaro, C., & Bailao, A. (2017). The colors of paintings and viewers' preferences. Vision Research, 130, 76-84. https://doi.org/10.1016/j.visres.2016.11.006 
    ...
    Peli, E. (1990). Contrast in complex images. Journal of the Optical Society of America Series A, 7(10), 2032-2040. https://doi.org/10.1364/josaa.7.002032 
    ...
    Rafegas, I., & Vanrell, M. (2017). Color representation in CNNs: parallelisms with biological vision. Proceedings of the IEEE International Conference on Computer Vision Workshops, 2697-2705. https://doi.org/10.1109/ICCVW.2017.318
    
    Redies, C. (2007). A universal model of esthetic perception based on the sensory coding of natural stimuli. Spatial Vision, 21(1-2), 97-117. https://doi.org/10.1163/156856807782753886 
    
    Redies, C. (2015). Combining universal beauty and cultural context in a unifying model of visual aesthetic experience. Frontiers in Human Neuroscience, 9, 219. https://doi.org/10.3389/fnhum.2015.00218 
    ...
    Redies, C., & Brachmann, A. (2017). Statistical image properties in large subsets of traditional art, Bad Art, and abstract art. Frontiers in Neuroscience, 11, 593. https://doi.org/10.3389/fnins.2017.00593 
    ...
    Ruderman, D. L. (1994). The statistics of natural scenes. Network, 5, 517-548. 
    ...
    Spehar, B., Walker, N., & Taylor, R. P. (2016). Taxonomy of individual variations in aesthetic responses to fractal patterns. Frontiers in Human Neuroscience, 10, 350. https://doi.org/10.3389/fnhum.2016.00350 
    
    Stanischewski, S., Altmann, C. S., Brachmann, A., & Redies, C. (2020). Aesthetic perception of line patterns: effect of edge-orientation entropy and curvilinear shape. i-Perception, 11(5), 2041669520950749. 
    ...
    Taylor, R. P., Newell, B., Spehar, B., & Clifford, C. W. G. (2005). Fractals: a resonance between art and nature. In M. Emmer (Ed.), The Visual Mind II (pp. 53-63). Cambridge: MIT Press. 
    ...
    Taylor, R. P., Spehar, B., Wise, J. A., Clifford, C. W., Newell, B. R., Hagerhall, C. M., Purcell, T., & Martin, T. P. (2005). Perceptual and physiological responses to the visual complexity of fractal patterns. Nonlinear Dynamics, Psychology, and Life Sciences, 9(1), 89-114. 
    
    Taylor, R. P., & Sprott, J. C. (2008). Biophilic fractals and the visual journey of organic screen-savers. Nonlinear Dynamics, Psychology, and Life Sciences, 12, 117-129. 
    ...
    Tolhurst, D. J., Tadmor, Y., & Chao, T. (1992). Amplitude spectra of natural images. Ophthalmologic and Physiological Optics, 12(2), 229-232. 
    
    Tong, H., Li, M., Zhang, H.-J., He, J., & Zhang, C. (2004). Classification of digital photos taken by photographers or home users. Lecture Notes in Computer Science, 3331, 198-205. 
    
    van Dongen, N. N. N., & Zijlmans, J. (2017). The science of art: The universality of the law of contrast. American Journal of Psychology, 130(3), 283-294. <Go to ISI>://WOS:000407872700003 
    
    Van Geert, E., & Wagemans, J. (2020). Order, complexity, and aesthetic appreciation. Psychology of Aesthetics, Creativity, and the Arts, 14(2), 135. https://doi.org/10.1037/aca0000224 
    ...
    Walther, D. B., Farzanfar, D., Han, S. H., & Rezanejad, M. (2023). The mid-level vision toolbox for computing structural properties of real-world images. Frontiers in Computer Science, 5. https://doi.org/10.3389/fcomp.2023.1140723 
    ...
    Watier, N. (2024). Measures of angularity in digital images. Behavior Research Methods, (published online). https://doi.org/10.3758/s13428-024-02412-5 
    ...
    Wundt, W. (1874). Grundzüge der physiologischen Psychologie. Leipzig: Wilhelm Engelmann Verlag. 
    
    Zhang, J., Miao, Y., & Yu, J. (2021). A comprehensive survey on computational aesthetic evaluation of visual art Images: Metrics and challenges. IEEE Access, 9. https://doi.org/10.1109/ACCESS.2021.3083075 
